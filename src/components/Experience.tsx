...
export default function Experience() {
  ...
  return (
    <section id="experience" className="section-alt relative py-24 sm:py-32">
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        ...
        <div className="relative">
          {/* Timeline line */}
          <div
            className="absolute left-4 top-0 hidden h-full w-px bg-gradient-to-b from-azure-500/50 via-azure-500/30 to-azure-500/20 md:left-1/2 md:block md:-translate-x-px"
            aria-hidden="true"
          />
                ...
                >
                  ...
                  <div className="absolute left-4 top-8 hidden md:left-1/2 md:block md:-translate-x-1/2">
                    ...
                    >
                      ...
                      <div className="absolute inset-0 animate-pulse-glow rounded-full bg-azure-400/30" />
                    </motion.div>
                  </div>
                    ...
                    <div className="glass-card-hover ml-10 p-6 md:ml-0">
                      <div className="mb-3 flex flex-wrap items-start justify-between gap-2">
                        <div>
                          ...
                          <div className="mt-1 flex items-center gap-2 text-azure-600">
                            <Briefcase className="h-4 w-4" aria-hidden="true" />
                            <span className="font-medium">{exp.company}</span>
                          </div>
                        </div>
                        <span className="rounded-full border border-azure-500/30 bg-azure-50 px-3 py-1 text-xs font-medium text-azure-300">
                          {exp.dates}
                        </span>
                      </div>
                      ...
                      <ul className="space-y-2">
                        {exp.bullets.map((bullet, i) => (
                          ...
                          >
                            <span
                              className="mt-2 h-1 w-1 shrink-0 rounded-full bg-gradient-to-r from-azure-400 to-azure-400"
                              aria-hidden="true"
                            />
                            {bullet}
                          </motion.li>
